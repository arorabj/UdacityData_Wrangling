...
for myurl in ebert_review_urls:
    rs = requests.get(myurl)
    with open(os.path.join(os.path.join(folder,downloadDir),myurl.split('/')[-1]), mode='wb') as myfile:
        myfile.write(rs.content)
